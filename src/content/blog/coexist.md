---
title: "Augmenting Our Own Intelligence"
description: "So you wanna predict the future with AI?"
image: https://sandyfoley.github.io/images/blog/coexist.png
...
Of course, every powerful technology attracts bad actors. There will be scams, misinformation, shortcuts, and companies that attempt to automate experiences that should remain human. Ironically, I suspect AI will become one of our most effective tools for detecting fraud, identifying misinformation, and reducing many of these problems.

One of the themes I saw while reading *The Infinity Machine* by Sebastian Mallaby is that progress rarely comes from machines alone. Breakthroughs happen because people are curious enough to ask the hard questions and persistent enough to keep going when answers don't point in the direction expected. 

Ten years from now, AI will be woven into daily life, quietly helping with thousands of daily tasks in the background. The most successful technologies tend to disappear into our everyday life. We simply _use_ electricity every time we turn on a light switch.

Perhaps that's the future we'll have with AI as well; a world where intelligence, both human and artificial, works together. This will be because millions of people found it useful, one small decision at a time.
